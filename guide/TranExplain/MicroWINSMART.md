...
4.打开PLC软件，选择“通信”，网卡选择VPN透传专用网卡“TAP-Win32 Adapter V9.TCPIP”（此网卡是安装FlexManager客户端后自动在系统中安装的），点击“添加CPU”，手动输入PLC的IP地址，建立连接后，可直接上传、下载或状态监控。  

![添加盒子分组](../Images/Trans/TranExplain/STEP7MicroWIN/PORATL13.png)  
